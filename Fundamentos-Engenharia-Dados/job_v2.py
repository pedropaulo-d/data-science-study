# Prática Enhenharia de Dados - Ciração de Pipeline de Extração, Limpeza, Transformação e Enriquecimento de Dados
...
with open('producao_alimentos.csv', 'r') as file:
    ...
    # Insere cara linha do arquivo com quantidade maior que 10 a tabela do banco de dados
    for row in reader:
        if int(row[1]) > 10:
